 ...
 <body>
 	<div class="container">
 		<div class="form">
 	<form action="cadastrar-usuario.php" method="post" class="form-login">
 		
 		<img width="150px" height="150px" src="img/novo_user.png"/>
 	...
 	<div class="novo-usuario.php">
 		<form action="index.php" method="post" class="retorno-login">
 			<button type="submit" class="btn btn-lg btn-primary btn-block">VOLTAR</button>
 		</form>
 	</div>
 </div>
 </div>
